...
<div id="content">
    <table id="tabel-input">
        ...
        <tr>
            ...
            <td class="isian-formulir"><?php echo $r_tampil_kembali['pinjam']; ?></td>
        </tr>
        <tr>
            <td class="label-formulir">Waktu Pengembalian </td>
            <td class="isian-formulir"><?php echo $r_tampil_kembali['waktu']; ?></td>
        </tr>
        <tr>
            <td class="label-formulir">Status</td>
            <td class="isian-formulir"><?php echo $r_tampil_kembali['status']; ?></td>
        </tr>
    </table>
</div>
<script>
