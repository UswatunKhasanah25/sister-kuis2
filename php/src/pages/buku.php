...
<div id="content">
    <p id="tombol-tambah-container">
        ...
        <a target="_blank" href="pages/cetak_all.php"><img src="print.png" height="50px" height="50px"></a>
        <a target="_blank" href="buku_pdf.php"><img src="pdf.jpg" height="50px" height="50px"></a>
        <a target="_blank" href="buku_excel.php"><img src="excel.png" height="50px" height="50px"></a>
            ...
            <?php 
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <div class="tombol-opsi-container"><a target="_blank" href="pages/cetak_buku.php?id=<?php echo $r_tampil_buku['idbuku']; ?>" class="tombol">Cetak Kartu</a></div>
